...
import Navbar from "components/navbar/superAdmin_index";
import SuperAdminSidebar from "components/sidebar/superAdmin_index";
...
export default function SuperAdmin(props) {
  ...
  const getActiveRoute = (routes) => {
    let activeRoute = "Super Admin Main Dashboard";
